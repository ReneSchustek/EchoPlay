...
namespace EchoPlay.App.ViewModels
{
    ...
    public sealed class SucheViewModel : ObservableObject, IDisposable
    {
        ...
        ///
        /// Reset-/Abbruch-Disziplin (Arbeitspaket 267): Trefferliste und Status-Hinweise werden
        ...
        // Suche an, weil die Bindings die alten Karten noch kurz halten (Arbeitspaket 269).

...
namespace EchoPlay.App.Tests.Services
{
    ...
    public sealed class ImportServiceTests
    {
        ...
        {
            // Arbeitspaket 268: Provider liefert dieselbe Folge mehrfach (Compilation/Re-Release).
        ...
        {
            // Arbeitspaket 273: Re-Import nutzt einen Batch-Insert statt N AddAsync-Aufrufe.
            FakeSeriesDataService seriesService = new();
            FakeEpisodeDataService episodeService = new();
            FakeAppSettingsDataService settings = new(new AppSettings());
        ...
        {
            // Arbeitspaket 273: Delta-Import sammelt neue Episoden und löst einen einzigen AddRangeAsync aus.
            FakeSeriesDataService seriesService = new();
            FakeEpisodeDataService episodeService = new();
            FakeAppSettingsDataService settings = new(new AppSettings());
        ...
        {
            // Arbeitspaket 273: Bestehende Episoden ohne Cover bekommen die Provider-CoverUrl

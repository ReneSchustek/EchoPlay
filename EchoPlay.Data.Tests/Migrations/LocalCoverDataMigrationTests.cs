...
{
    /// <summary>
    /// Regressions-Tests für die Migration <c>MigrateLocalCoverDataToCoverImages</c> (Arbeitspaket 240).
    ...
    public sealed class LocalCoverDataMigrationTests : IAsyncLifetime, IDisposable
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            // Schema bis zum Vorgänger der Arbeitspaket-240-Migration aufbauen,

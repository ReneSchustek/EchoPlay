...
namespace EchoPlay.LocalLibrary.Cover
{
    ...
    public sealed class CoverService
    {
        ...
        [SuppressMessage("Design", "CA1054:URI-like parameters should not be strings",
            Justification = "Internal API nimmt die URL so entgegen, wie sie in DB/DTO (Provider-URL-String) abgelegt ist. Uri-Refactor würde Cascade durch Cover-Kaskade erfordern, Entscheidung dokumentiert in Arbeitspaket 231.")]

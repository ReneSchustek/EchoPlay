    ...
    public interface ILocalCoverService
    {
        ...
        Task<byte[]?> ResolveAsync(string seriesFolder,
            [SuppressMessage("Design", "CA1054:URI-like parameters should not be strings",
                Justification = "Internal API nimmt die URL so entgegen, wie sie in der DB-Spalte Series.CoverImageUrl abgelegt ist. Uri-Refactor würde Cascade durch Cover-Kaskade erfordern, Entscheidung dokumentiert in Arbeitspaket 231.")]

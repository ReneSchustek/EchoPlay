...
namespace EchoPlay.App.Tests.Fakes
{
    ...
    internal sealed class FakeEpisodeDataService : IEpisodeDataService
    {
        ...
        /// <summary>Zähler für Aufrufe von <see cref="GetByIdAsync"/> – Arbeitspaket 273 N+1-Detektion.</summary>
        public int GetByIdAsyncCallCount { get; private set; }

        /// <summary>Zähler für Aufrufe von <see cref="GetByIdsAsync"/> – Arbeitspaket 273 Batch-Verifikation.</summary>
        public int GetByIdsAsyncCallCount { get; private set; }

        /// <summary>Zähler für Aufrufe von <see cref="AddAsync"/> – Arbeitspaket 273 N+1-Detektion.</summary>
        public int AddAsyncCallCount { get; private set; }

        /// <summary>Zähler für Aufrufe von <see cref="AddRangeAsync"/> – Arbeitspaket 273 Batch-Verifikation.</summary>
        public int AddRangeAsyncCallCount { get; private set; }

        /// <summary>Zähler für Aufrufe von <see cref="UpdateAsync"/> – Arbeitspaket 273 N+1-Detektion.</summary>
        public int UpdateAsyncCallCount { get; private set; }

        /// <summary>Zähler für Aufrufe von <see cref="UpdateRangeAsync"/> – Arbeitspaket 273 Batch-Verifikation.</summary>

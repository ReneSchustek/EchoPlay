    ...
    public interface ICoverImageDataService
    {
        ...
        Task SetCoverAsync(string entityType, Guid entityId, byte[] imageData,
            [SuppressMessage("Design", "CA1054:URI-like parameters should not be strings",
                Justification = "Internal API akzeptiert die URL so, wie sie in der DB-Spalte CoverImage.SourceUrl persistiert wird. Uri-Refactor würde Cascade durch Cover-Kaskade und Call-Sites erfordern, Entscheidung dokumentiert in Arbeitspaket 231.")]

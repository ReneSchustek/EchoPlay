...
namespace EchoPlay.App.Pages
{
    ...
    public sealed partial class TagManagerPage : Page
    {
        ...
        /// </summary>
        private async void OnLookupResultsReady(object? sender, IReadOnlyList<TagLookupResult> results)
        {
            ...
            if (dialogResult == ContentDialogResult.Primary && resultList.SelectedItem is TagLookupResult selected)
            {
                ViewModel.ApplyLookupResult(selected);
            }
        }
        ...
        /// </summary>
        private void OnAutoLookupApplied(object? sender, TagLookupResult result)
        {

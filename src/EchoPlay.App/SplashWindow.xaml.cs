...
namespace EchoPlay.App
{
    ...
    public sealed partial class SplashWindow : Window
    {
        ...
        public SplashWindow()
        {
            ...
            // Arbeitspaket 329 / WCAG 1.1.1: Logo dekorativ markieren — Screen-Reader skippt es.
            // Bewusst per Code-Behind statt XAML, weil das XAML-Markup-Pattern unter
            // unpackaged WinUI 3 einen Markup-Reader-Bug ausgeloest hat (Arbeitspaket 327
